...
каналами.
    ...
    def loss(self, X, y=None):
        """
        Evaluate loss and grad for the three-layer convolutional network.
        ...
        hidden_grad, dw3, db3 = affine_backward(dout, cache_out)

        grads['W3'] = dw3 + self.reg * W3
        grads['b3'] = db3
        
        flattened_grad, dw2, db2 = affine_relu_backward(hidden_grad, cache_hidden)

        grads['W2'] = dw2 + self.reg * W2
        grads['b2'] = db2
        
        conv_grad = flattened_grad.reshape(N, F, H_out, W_out)
        
        _, dw1, db1 = conv_relu_pool_backward(conv_grad, cache_conv)
